...
.lb-coin{width:100%;height:100%;border-radius:9px;display:flex;align-items:center;justify-content:center;will-change:transform,opacity;font-family:'Special Elite',serif;cursor:default;position:relative;overflow:hidden;animation:lbCoinFlip var(--flip-dur,.7s) cubic-bezier(.4,0,.2,1) var(--flip-delay,0s) both;}
/* Top-left gloss */
